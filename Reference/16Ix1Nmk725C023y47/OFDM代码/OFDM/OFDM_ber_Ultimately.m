...
%==============串并变换====================================
%矩阵转置时附加有取共轭
complex_carrier_matrix1=reshape(complex_carrier_matrix',Np_carr,Sig_per_carr)';%串并变换symbols_per_carrier*carrier_count 矩阵
%complex_carrier_matrix1=conj(reshape(complex_carrier_matrix',carrier_count,symbols_per_carrier)')%两次转置
